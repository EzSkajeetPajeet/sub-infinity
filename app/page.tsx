...
export default function Home() {
  ...
  // Reveal-on-scroll
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.reveal, .reveal-scale, .reveal-line');
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased selection:bg-amber-400/30 selection:text-amber-100">
      ...
      {/* SCROLL PROGRESS */}
      <div id="scroll-progress-bar" className="scroll-progress w-full" style={{ transform: 'scaleX(0)' }} />
      ...
      <nav className="fixed w-full z-50 border-b border-white/5 bg-[#070a12]/70 backdrop-blur-md">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-b border-white/5 bg-[#070a12] px-6 py-6 space-y-4 tracking-widest uppercase text-xs">
            <a href="#problem" onClick={() => setMobileMenuOpen(false)} className="block text-slate-400 hover:text-white">Problem</a>
            <a href="#solution" onClick={() => setMobileMenuOpen(false)} className="block text-slate-400 hover:text-white">Workspace</a>
            <a href="#architecture" onClick={() => setMobileMenuOpen(false)} className="block text-slate-400 hover:text-white">Disciplines</a>
            <a href="#vision" onClick={() => setMobileMenuOpen(false)} className="block text-slate-400 hover:text-white">Vision</a>
      ...
      {/* [1] HERO SECTION — full-bleed cinematic photo backdrop */}
      <section className="relative pt-48 pb-40 px-6 overflow-hidden">
        {/* Background photo + gradient wash, pulled up behind the nav */}
        <div className="absolute inset-x-0 -top-24 bottom-0 -z-10 ambient-glow">
          <img
            src="/sample1.png"
            alt="Earth observed from orbit"
            className="w-full h-full object-cover opacity-80"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#05070d]/20 via-[#05070d]/55 to-[#05070d]" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#05070d]/70 via-transparent to-[#05070d]/70" />
        </div>

        <div className="max-w-4xl mx-auto text-center">
          <div className="reveal inline-flex items-center gap-2 px-3 py-1 mb-8 text-[10px] tracking-[0.3em] uppercase border border-amber-500/30 rounded-full bg-amber-500/10 backdrop-blur-sm text-amber-300">
            <span>SCIENTIFIC INFRASTRUCTURE</span>
          </div>
          ...
          <p className="reveal text-sm md:text-base text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed" style={{ ['--reveal-delay' as string]: '180ms' }}>
            A research workspace for physicists to organize complex datasets, visualize signals and systems, track experiments, manage analysis workflows, and move from raw data to real insight.
          </p>

          <div className="reveal flex flex-col sm:flex-row justify-center gap-4" style={{ ['--reveal-delay' as string]: '260ms' }}>
            <a href="#cta" className="bg-amber-400 text-slate-950 px-8 py-3.5 rounded text-sm font-bold tracking-wider uppercase hover:bg-amber-300 transition-colors shadow-lg shadow-amber-500/20">
              Join Early Access
            </a>
            <a href="#vision" className="border border-white/20 bg-white/5 backdrop-blur-sm text-slate-200 px-8 py-3.5 rounded text-sm font-medium tracking-wider uppercase hover:bg-white/10 transition-colors">
              View the Vision
            </a>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={idx}
                className="reveal p-6 rounded border border-slate-900 bg-slate-950/40 hover:border-amber-500/20 transition-colors relative"
                style={{ ['--reveal-delay' as string]: `${idx * 90}ms` }}
              >
                <div className="text-amber-400/40 text-xs font-mono mb-4">0{idx + 1}.</div>
                <p className="text-slate-300 text-sm leading-relaxed">{problem}</p>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={idx}
                className="reveal flex items-center gap-3 p-4 rounded border border-slate-900 bg-slate-900/10"
      ...
      <section id="architecture" className="py-24 px-6 border-t border-slate-900 bg-slate-950/20 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="reveal-scale border border-slate-900 bg-[#0a0f1d] p-8 rounded font-mono text-xs text-slate-400 mb-12 overflow-x-auto">
            <div className="min-w-[600px] text-center">
              <div className="inline-block border border-amber-500/40 bg-amber-500/5 text-amber-400 px-6 py-2 rounded text-sm font-semibold tracking-widest">
                SUB-INFINITY CORE
              </div>
          ...
          <div className="reveal-line border-l border-amber-500/30 pl-6 max-w-3xl">
            <p className="text-xs tracking-widest text-slate-500 uppercase mb-3">Cross-Disciplinary Application</p>
            <p className="text-slate-400 text-xs leading-relaxed mb-4">
              Applicable across astrophysics, particle physics, plasma physics, condensed matter, quantum physics, nuclear physics, biophysics, materials science, cosmology, optics, and other data-driven areas of physics.
            </p>
      ...
      <section className="py-24 px-6 border-t border-slate-900">
        <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="reveal-scale md:col-span-5 rounded border border-slate-900 overflow-hidden">
            <img src="/sample2.png" alt="Waterfall plot preview" className="w-full h-40 object-cover border-b border-slate-900" />
            <div className="bg-slate-950 p-6 font-mono text-xs">
              <span className="text-slate-500 block mb-3 text-[10px] uppercase tracking-wider">// Active Core Framework Modules</span>
              <ul className="space-y-2 text-slate-300">
                <li className="flex justify-between border-b border-slate-900 pb-1"><span>• HDF5 scientific files</span><span className="text-amber-400/60">Ready</span></li>
                <li className="flex justify-between border-b border-slate-900 pb-1"><span>• Waterfall plots</span><span className="text-amber-400/60">Ready</span></li>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-center text-xs font-mono mb-16">
            {["Upload Dataset", "Auto-organize Files", "Extract Metadata", "Visualize Data", "Detect/Annotate", "Export Notes"].map((step, idx) => (
              <div
                key={idx}
                className="reveal p-4 border border-slate-900 bg-[#070a12] rounded relative group hover:border-amber-500/30 transition-colors"
          ...
          <div className="grid md:grid-cols-2 gap-8 text-sm">
            <div className="reveal space-y-3 text-slate-400">
              <p>• Upload massive heterogeneous scientific datasets directly via terminal or interface.</p>
              <p>• Automatically catalog files by project, instrument, timestamps, field, or unique metrics.</p>
              <p>• Generate hardware-accelerated visual transforms instantly in-browser.</p>
            </div>
            <div className="reveal space-y-3 text-slate-400" style={{ ['--reveal-delay' as string]: '100ms' }}>
              <p>• Graphically isolate, flag, and annotate persistent mathematical anomalies or signals.</p>
              <p>• Archive underlying execution telemetry seamlessly via immutable research logging.</p>
              <p>• Render figures, logs, and summaries instantly to publishable Markdown/LaTeX assets.</p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="reveal p-6 border border-slate-900 bg-slate-950/40 rounded"
      ...
      {/* [8] LONG-TERM VISION */}
      <section id="vision" className="py-24 px-6 border-t border-slate-900 bg-slate-950/20 relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img src="/sample3.png" alt="Deep space backdrop" className="w-full h-full object-cover opacity-25" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a0f1d]/40 via-[#0a0f1d]/80 to-[#0a0f1d]" />
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6 max-w-xl mx-auto font-mono text-xs">
            {[
              ...
              <div key={idx} className="reveal flex flex-col items-center" style={{ ['--reveal-delay' as string]: `${idx * 100}ms` }}>
                <div className="w-full border border-slate-900 bg-[#070a12]/80 backdrop-blur-sm p-4 rounded text-center hover:border-amber-400/20 transition-colors">
                  <span className="text-amber-400 text-[10px] tracking-widest block mb-1">{step.phase}</span>
                  <span className="text-slate-200 font-medium tracking-wide">{step.name}</span>
                </div>
                {idx < 3 && <div className="text-slate-700 my-2 text-center text-sm">↓</div>}
          ...
          <p className="reveal text-center text-xs text-slate-500 font-medium mt-12 italic">
            "The mission is to build tools that help scientists now, then use that foundation to support deeper scientific exploration later."
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 border-t border-slate-900">
        <div className="max-w-4xl mx-auto">
          <div className="reveal-scale border border-slate-900 bg-[#080d1a]/50 p-8 md:p-12 rounded relative">
            <span className="text-[10px] tracking-[0.3em] text-amber-400 uppercase block mb-4">// Genesis Statement</span>
            <h2 className="text-xl md:text-2xl font-light tracking-wide text-white mb-6">Built from real research frustration.</h2>
            <div className="space-y-4 text-slate-400 text-xs md:text-sm leading-relaxed">
              <p>
