      ...
      <nav className="fixed w-full z-50 border-b border-slate-900 bg-[#070a12]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <img src="/logo-icon-new-symbol.png" alt="Sub-Infinity Icon" className="h-15 w-auto" />
      ...
      <section className="relative pt-48 pb-32 px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <img src="/logo-icon-new-symbol.png" alt="Sub-Infinity" className="w-32 md:w-48 h-auto mb-6 opacity-90" />
